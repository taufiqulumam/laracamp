                        ...
                        <div class="col-lg-6 col-12">
                            <form action="{{ route('checkout.store', $camp->id) }}" class="basic-form" method="POST">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input name="card_number" type="number" maxlength="16" class="form-control {{ $errors->has('card_number') ? 'is-invalid' : '' }}" value="{{ old('card_number') ? : '' }}" required />
                                ...
                                <div class="mb-5">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-12">
                                            ...
                                            <input name="cvc" type="password" maxlength="3" class="form-control {{ $errors->has('cvc') ? 'is-invalid' : '' }}" value="{{ old('cvc') ? : '' }}" required />
                                            @if ($errors->has('cvc'))
